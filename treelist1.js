...
var domain_selector='<select name="domain_' + thing_id + '" id="domain_' + thing_id + '" class="custom-select-sm domain_selector"> '+GetDomainOptions()+' </select>'
    var inputs = '<div class="form-group" style="background: aliceblue;"> <label for="Frequency_' + thing_id + '">Frequency:</label> <input type="range" class="form-control slider" min="1" max="100" value="50" id="Frequency_' + thing_id + '"> <span id="Frequency_' + thing_id + '">50</span></div> '
        + '<div class="form-group" style="background: aliceblue;"> <label for="Sensitivity_' + thing_id + '">Sensitivity:</label> <input type="range" class="form-control slider"  min="1" max="100" value="50" id="Sensitivity_' + thing_id + '"><span id="Sensitivity_' + thing_id + '">50</span></div>'
        + '<div class="form-group" style="background: aliceblue;"> <label for="Freshness_' + thing_id + '">Freshness:</label> <input type="range" class="form-control slider" min="1" max="100" value="50" id="Freshness_' + thing_id + '"> <span id="Freshness_' + thing_id + '">50</span></div>'
        + '<div class="form-group" style="background: aliceblue;"> <label for="Time_' + thing_id + '">Time:</label> <input type="range" class="form-control slider" min="1" max="100" value="50" id="Time_' + thing_id + '"> <span id="Time_' + thing_id + '">50</span></div> '
        + '<div class="form-group" style="background: aliceblue;"> <label for="Volume_' + thing_id + '">Volume:</label> <input type="range" class="form-control slider" min="1" max="100" value="50" id="Volume_' + thing_id + '"> <span id="Volume_' + thing_id + '">50</span></div> '
        + '<div class="form-group" style="background: aliceblue;"> <label for="Criticality_' + thing_id + '">Criticality:</label> <input type="range" class="form-control slider" min="1" max="100" value="50" id="Criticality_' + thing_id + '"><span id="Criticality_' + thing_id + '">50</span> </div>';
    //return '<div id="fog'+fog_counter+'_thing' + counter + '" class="thing" data-parent="#fog' + fog_counter + '">  <a class="card-link" data-toggle="collapse" href="#fog' + fog_counter + '_thing' + counter + '_details">  <div class="input-group mb-3">  <div class="input-group-prepend">  <span class="input-group-text"><i class="fas fa-cloud"></i></span>  </div>  <button type="button" class="btn btn-outline-primary thing"> Thing</button>  <div class="input-group-prepend">  <span id="fog'+fog_counter+'_thing' + counter + '" class="deletingThing input-group-text thing1"><i class="fa fa-times"></i></span>     </div>  </div>  </a>  <div id="fog' + fog_counter + '_thing' + counter + '_details" class="collapse show" data-parent="#fog'+fog_counter+'_thing' + counter + '">  Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et  dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip  ex ea commodo consequat.   </div> </div>';
