...
// echo  $out;
 ...
 <head>
     ...
     <script src="treelist1.js"></script>
 </head>
     ...
     <section class="page-section portfolio" id="portfolio">
         ...
         <div class="container">
             ...
             <div class="input-group mb-3">
                 ...
                 <button type="button" onclick="AddCloud()" class="btn btn-outline-primary cloud" style="margin-right: 5px;"> Cloud</button>
                 <button type="button" onclick="AddFog()" class="btn btn-outline-primary Fog" style="margin-right: 5px;"> Fog</button>
                 <button type="button" onclick="AddThing()" class="btn btn-outline-primary Thing" style="margin-right: 5px;"> Thing</button>
                 <button type="button" onclick="AddDomain()" class="btn btn-outline-primary Domain"> Domain</button>  </div>
           </div>
             <!-- <div id="accordion" class="border">
                    <div id="addingButtons" style="padding-top: 15px; padding-left: 15px;" class="collapse show" data-parent="#accordion">
             ...
             <div class="container ">
                 <div class="row">
                     <div id="clouds" class="col-sm border">
                         Clouds


                     </div>
                     <div id="fogs" class="col-sm border">
                         Fogs
                     </div>
                     <div id="things" class="col-sm border">
                         Things
                     </div>
                 </div>
             </div>
             ...
             <div class="container" id="div_DistanceMatrix" style="display:none;">
                 <h2>Distance Matrix</h2>
                 <table class="table" id="DistanceMatrix">
                     <thead>
                         <tr>
                             <th> </th>
                             <th>Domain 1</th>
                     ...
                     <tbody>
                         <tr>
                             <td>Domain 1</td>
                             <td> <input type="number" value="1" id="quantity" name="quantity" min="1"></td>
                         </tr>
             ...
             <div class="container" id="div_rateSendMatrix" style="display:none;">
                 <h2>Send Rate Matrix</h2>
                 <table class="table" id="rateSendMatrix">
                     <thead>
                         <tr>
                             <th> </th>
                             <th>Domain 1</th>
                 ...
                 <div id="Criteria" class="panel-collapse collapse">
                     <div class="form-group" style="background: aliceblue;">
                         ...
                         <label for="FrequencyPriority">Priority: </label><select name="FrequencyPriority" id="FrequencyPriority" class="custom-select-sm">
                             <option value="0">Un Classified</option>
                     ...
                     <div class="form-group" style="background: aliceblue;">
                         ...
                         <label for="SensitivityPriority">Priority: </label><select name="SensitivityPriority" id="SensitivityPriority" class="custom-select-sm">
                             <option value="0">Un Classified</option>
                             <option value="1" selected>1</option>
                             <option value="2">2</option>
                             <option value="3">3</option>
                     ...
                     <div class="form-group" style="background: aliceblue;">
                         ...
                         <label for="TimePriority">Priority: </label><select name="TimePriority" id="TimePriority" class="custom-select-sm">
                             <option value="0">Un Classified</option>
                             <option value="1" selected>1</option>
                             <option value="2">2</option>
                             <option value="3">3</option>
